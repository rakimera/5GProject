...
public class TranslatorTypeMapProfile : Profile
{
    public TranslatorTypeMapProfile()
    {
        CreateMap<TranslatorType, TranslatorTypeDto>()
            ...
            .ForMember(dest => dest.LastModifiedBy, opt =>
                opt.MapFrom(src => src.LastModifiedBy)).ReverseMap();
    }
}